import{dF as x,e0 as ae,cQ as c,cS as de,cB as C,cC as L,cF as w,cG as y,cH as d,cE as l,d6 as W,c$ as _,dg as u,cD as ue,cJ as D,cX as g,de as j,dY as he,dL as V,cU as U,dp as R,d3 as F,cM as pe,cR as O,dH as z,dV as ee,df as me,cL as ne,e1 as fe,e2 as we}from"./index-BNfSSo9G.js";import"./index-DPwndSFp.js";import{S as be}from"./SwapController-BMK6dAY1.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
