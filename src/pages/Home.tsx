...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {statistics.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-10 h-10 bg-gray-100 rounded-lg mb-3 text-gray-600">
                  {stat.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-600 max-w-2xl mx-auto">
              Tailored solutions for your industry's unique requirements
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {categories.map((category) => (
              <Link
                key={category.path}
                to={category.path}
                className="group bg-white/60 backdrop-blur-sm rounded-xl border border-gray-200 hover:border-gray-300 hover:bg-white/80 transition-all overflow-hidden"
              >
                {/* Header Video */}
                <div className="relative h-20 overflow-hidden border-b border-gray-200/50">
                  <video
                    autoPlay
                    loop
                    muted
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center text-xs text-gray-700 font-medium group-hover:gap-1 transition-all">
                    Explore
      ...
      {/* Features Section */}
      <section className="py-16 sm:py-24 px-4 sm:px-8 bg-white/40 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">
              Why Choose PrivateCharterX Escrow
            </h2>
            <p className="text-sm text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white/60 backdrop-blur-sm p-6 rounded-xl border border-gray-200"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {howItWorks.map((step, index) => (
              <div key={index} className="text-center">
                <div className="w-12 h-12 bg-gray-900 text-white rounded-full flex items-center justify-center text-base font-semibold mx-auto mb-3">
                  {step.step}
                </div>
          ...
          <div className="text-center mt-10">
            <Link
              to="/how-it-works"
              className="inline-flex items-center gap-1.5 text-sm text-gray-700 font-medium hover:gap-2 transition-all"
            >
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-600 max-w-2xl mx-auto">
              Our commitment to security and compliance ensures your high-value transactions are protected
            </p>
          </div>
