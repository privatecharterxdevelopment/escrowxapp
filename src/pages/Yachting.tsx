...
export default function Yachting() {
  ...
  const handleCreateEscrow = (serviceType?: string) => {
    if (user) {
      navigate('/dashboard', { state: { category: 'yachting', serviceType } });
    } else {
      openLogin();
    }
  };
  ...
  const services = [
    {
      title: 'Yacht Purchases',
      description: 'Full acquisition protection for motor yachts and sailing vessels',
      value: 'Typical: $5M-$150M',
      details: 'Comprehensive escrow for new and brokerage yacht sales. Includes sea trial deposits, survey contingencies, and title transfer protection.',
      categories: ['Motor Yachts', 'Sailing Yachts', 'Superyachts'],
    },
    {
      title: 'Charter Bookings',
      description: 'Secure seasonal and extended charter agreements',
      value: 'Typical: $50K-$1M per week',
      details: 'Protection for charter deposits and advance season bookings. Funds held until charter completion with provisions for weather cancellations.',
      categories: ['Weekly Charters', 'Seasonal Bookings', 'Long-term Charters'],
    },
    {
      title: 'Yacht Management Services',
      description: 'Annual management contracts with milestone releases',
      value: 'Typical: $100K-$2M annually',
      details: 'Escrow for comprehensive yacht management agreements including crew, maintenance, and operational oversight.',
      categories: ['Full Management', 'Technical Management', 'Crew Management'],
    },
    {
      title: 'Maintenance & Refit Contracts',
      description: 'Major refits, upgrades, and scheduled maintenance',
      value: 'Typical: $500K-$10M',
      details: 'Milestone-based payment releases for major refit projects, system upgrades, and comprehensive maintenance programs.',
      categories: ['Major Refit', 'System Upgrades', 'Cosmetic Updates'],
    },
    {
      title: 'Crew Services',
      description: 'Professional crew contracts and staffing agreements',
      value: 'Typical: $75K-$750K',
      details: 'Escrow for captain contracts, crew hiring, and professional staffing services for luxury vessels.',
      categories: ['Captain Contracts', 'Full Crew', 'Seasonal Staff'],
    },
    {
      title: 'Marina Berth Agreements',
      description: 'Premium berth leases and marina service contracts',
      value: 'Typical: $25K-$500K',
      details: 'Secure long-term berth reservations at premium marinas worldwide with service package protection.',
      categories: ['Annual Berths', 'Transient Docking', 'Winter Storage'],
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Multi-signature escrow protection for high-value yacht transactions',
    },
    {
    ...
    },
    {
      ...
      description: 'IPFS-backed immutable storage for marine agreements',
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100">
      ...
      <section className="relative overflow-hidden" style={{ height: '65vh', minHeight: '500px' }}>
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://oubecmstqtzdnevyqavu.supabase.co/storage/v1/object/public/fucking%20videos/4936422-uhd_4096_2160_24fps.mp4" type="video/mp4" />
          </video>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 h-full flex items-center">
          <div className="max-w-2xl">
            <h1 className="text-4xl sm:text-5xl font-light text-white mb-6 leading-tight">
              Yachting Escrow Services
            </h1>
            <p className="text-base text-white/90 mb-4 leading-relaxed max-w-xl">
              Institutional-grade escrow solutions for yacht acquisitions, charter agreements, and marine services.
            </p>
            <p className="text-sm text-white/70 mb-8">
              Transactions from $25,000 to $150M+ • Smart contract secured • IPFS documented
            </p>
            <button
