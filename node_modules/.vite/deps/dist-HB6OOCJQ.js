...
function encodeBase64(array2) {
  ...
  if (typeof Buffer !== "undefined") {
    base643 = Buffer.from(array2).toString("base64");
  } else {
    base643 = btoa(
      Array.from(array2).map((b) => String.fromCharCode(b)).join("")
    );
  }
  return base643.replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "");
}
function decodeBase64(base64url) {
  let base643 = base64url.replace(/-/g, "+").replace(/_/g, "/");
...
function utf8StringToBuffer(value) {
  if (typeof TextEncoder !== "undefined") {
    ...
    const bytes2 = new Uint8Array(value.length);
...
function base64ToHex(base643) {
  const bytes2 = decodeBase64(base643);
...
function generateAuthenticatorIdHash(credentialId) {
  ...
  const base643 = credentialId.replace(/-/g, "+").replace(/_/g, "/") + padding;
  const binaryString = atob(base643);
  const bytes2 = new Uint8Array(binaryString.length);
  for (let i = 0; i < binaryString.length; i++) {
    bytes2[i] = binaryString.charCodeAt(i);
  }
  return keccak256(bytes2);
}
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=dist-HB6OOCJQ.js.map
