...
var h = (r, e) => V(r, G(e));
function D(r) {
  return h(g({}, r), { level: (r == null ? void 0 : r.level) || b.level });
}
function y(r, e, t = l) {
  return r[t] = e, r;
}
    ...
    if (ChainController.state.activeChain === ConstantsUtil.CHAIN.EVM) {
      const rdnsCandidates = [
        ...connectors.flatMap((c2) => {
          var _a2;
          return ((_a2 = c2.connectors) == null ? void 0 : _a2.map((sc) => {
            var _a3;
...
var controller6 = {
  ...
  getAnnouncedConnectorRdns() {
    return state12.connectors.filter((c2) => c2.type === "ANNOUNCED").map((c2) => {
      var _a2;
      return (_a2 = c2.info) == null ? void 0 : _a2.rdns;
    });
  },
...
var controller8 = {
  ...
  async handleAuthAccountSwitch({ address, namespace }) {
    ...
    const smartAccount = (_b = (_a2 = accountData == null ? void 0 : accountData.user) == null ? void 0 : _a2.accounts) == null ? void 0 : _b.find((c2) => c2.type === "smartAccount");
...
async function loadViemUtils() {
  if (!cachedViemUtils) {
    const { createPublicClient, http, defineChain } = await import("./_esm-LDFOA2VU.js");
    cachedViemUtils = {
      createPublicClient,
      http,
      defineChain
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CYMMX2OQ.js.map
