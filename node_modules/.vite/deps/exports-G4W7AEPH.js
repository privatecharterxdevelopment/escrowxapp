  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-AX6PT6XE.js");
...
function coinbaseWallet(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await import("./dist-QYWIECNP.js");
...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/gemini.js
gemini.type = "gemini";
function gemini(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      var _a, _b, _c, _d;
      if (!walletProvider) {
        const { GeminiWalletProvider } = await import("./dist-HB6OOCJQ.js");
    ...
    return {
      async connect({ chainId = chains[0].id, ...rest } = {}) {
        ...
        try {
          if (!(accounts == null ? void 0 : accounts.length) && !isReconnecting) {
            const { RpcSchema } = await import("./connectors-V5FGSIHF.js");
            const { z } = await import("./connectors-EBW7UZLC.js");
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./connectors-V5FGSIHF.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-PBTU3HWE.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-IISSNMXG.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-Z5MXUAE7.js");
...
//# sourceMappingURL=exports-G4W7AEPH.js.map
